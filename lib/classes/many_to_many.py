...
class Magazine:
    ...
    # def top_publisher(cls, magazine):
        ...
        # if magazine_all_publications := [article for article in Article.all if article.magazine is magazine]:
        #     return max(
        #         cls.all,
        #         key=lambda mag: sum(1 for article in magazine_all_publications if article.magazine is mag)
        #     )
